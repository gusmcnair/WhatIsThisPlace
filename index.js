...
function getLocationFromInput(locationName) {
    ...
    function displayTextError(){
        $(".display-error").append("We couldn't find that place. Make sure you're connected to the Internet and try searching again.")
        $(".loading-screen").hide();
    }
...
function showPlaceInfo() {
        ...
        $(".loading-screen").hide();
        $(".instructions").empty();
        $(".instructions").append("Want to search for another place? Press the button below to get your location using GPS. Make sure your device or browser has permission to access your location.");
    }
